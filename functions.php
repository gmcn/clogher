...
include(get_template_directory() . '/functions/auctions.php' );
include(get_template_directory() . '/functions/products.php' );
include(get_template_directory() . '/functions/sales-reports.php' );
include(get_template_directory() . '/functions/sales-rings.php' );

function add_custom_sizes() {
		add_image_size( 'product-archive', 270, 360, array( 'center', 'center' ) ); // Hard crop left top
		add_image_size( 'slide-mobile', 1280, 854, array( 'center', 'center' ) ); // Hard crop left top
		add_image_size( 'header-mobile', 500, 224, array( 'center', 'center' ) ); // Hard crop left top
}
